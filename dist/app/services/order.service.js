...
import { OrderUtils } from '../models/order';
let OrderService = class OrderService {
    ...
    getOrders({ userId }) {
        ...
        return this.http
            ...
            return ordersBackend.map(orderBackend => OrderUtils.fromBackendFormat(orderBackend));
    ...
    createOrder(order) {
        ...
        console.log("Datos finales a enviar al backend", JSON.stringify(orderBackendData, null, 2));
        return this.http.post(this.apiUrl, orderBackendData, { headers }).pipe(map((response) => {
    ...
    enviarAlbaranPorEmail(pedido, usuario, pdfBase64) {
        ...
        const headers = this.getAuthHeaders();
        return this.http
            .post(`${this.apiUrl}/enviar-albaran-email`, { pedido, usuario, pdfBase64 }, { headers })
